...
Only the owner of a poll with superuser or staff access can add poll , edit poll, update poll, delete poll , add choice,
 ...
 There is a search option for polls. Also user can filter polls by name, publish date, 
 and by number of voted. Pagination will work even after applying filter.
